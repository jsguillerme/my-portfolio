export function Header() {
  return (
    <div className="max-w-[1124px] mx-auto w-full h-36 max-h-28 px-8 max-sm:p-4 flex items-center justify-between max-sm:h-fit max-sm:flex-col max-sm:items-center max-sm:justify-center max-sm:gap-4">
